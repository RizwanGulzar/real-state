        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12 m-0">
                <div class="bg-light rounded h-100 p-4">
                   <col-4>
                   <h2 class="mb-4"><i class="fa fa-plus"></i> Add user</h2></col-4>
                    <div class="col-md-8">
                    <?php
                    ...
                    <form action="./add-user-qry.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" name="mobile" class="form-control" id="floatingInput" placeholder="name@example.com">
